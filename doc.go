...
go-selfupdate validates SHA256 checksums by default, but this is pluggable via the Hash
...
In order to update a Go application with go-selfupdate, you must distributed it as a single executable.
